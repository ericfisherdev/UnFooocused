...
def _build_generate_args(body: dict) -> list:
    ...
    args = [
        ...
        *lora_args,
        ...
        float(body.get("adaptive_cfg", cfg.default_cfg_tsnr)),
        int(body.get("clip_skip", cfg.default_clip_skip)),
        ...
        bool(body.get("inpaint_disable_initial_latent", False)),
        body.get("inpaint_engine", cfg.default_inpaint_engine_version),
